const templates = {
  list: '#ext-training-contact-tiles-ng/list.html',
};
...
export let filterCriteria = 'manager';
export default ({ widget }) => ({
  applyFilter: (selectedFilter) => {
    console.log("THis is testing" + selectedFilter);
  filterCriteria = selectedFilter;
  // This is a special function exposed via Widget API to refresh the widget
  widget.render();
},
});